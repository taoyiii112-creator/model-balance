...
- 手机 App（Flutter）：v0.2.4 已打包（v0.2.2/v0.2.3 已发布 GitHub Release），待实机安装验证
...
- 2026-08-07 手机 App v0.2.5：余额趋势折线图（近30天）+ 自动刷新间隔可调
- 2026-08-07 手机 App v0.2.4：启动兜底清理临时包、更新源兼容 version.json、保存异常处理与格式校验
- 2026-08-07 手机 App v0.2.3：更新安装后自动清理临时 APK
...
- 2026-08-07 手机端更新源可配置 + 检查失败提示（v0.2.2，已发布 Release）
- 2026-08-07 exe 打包（dist/model-balance.exe，免 Python 分发）
- 2026-08-07 余额趋势图与低余额提醒（v0.2.2）
